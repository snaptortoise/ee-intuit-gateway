...
<?php	
		...
		if (file_exists(EVENT_ESPRESSO_GATEWAY_DIR . "/intuit/settings.php")){
			require_once(EVENT_ESPRESSO_GATEWAY_DIR . "/intuit/settings.php");
			event_espresso_intuit_settings();
		}elseif (file_exists(EVENT_ESPRESSO_PLUGINFULLPATH."gateways/intuit/settings.php")){
			require_once(EVENT_ESPRESSO_PLUGINFULLPATH."gateways/intuit/settings.php");
			event_espresso_intuit_settings();
		}
